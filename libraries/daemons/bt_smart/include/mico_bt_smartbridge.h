 ...
 */
typedef OSStatus (*mico_bt_smartbridge_bonding_callback_t)      ( mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_bond_info_t* bond_info );
...
struct mico_bt_smartbridge_socket
{
    ...
    mico_bt_smartbridge_bonding_callback_t        bonding_callback;               /**< Callback for handling pairing/bonding successful event        */
 ...
 * \li complete_callback runs on the context of MICO_NETWORKING_WORKER_THREAD
 ...
 *
 * @warning
 * \li Callback functions run on the context of MICO_NETWORKING_WORKER_THREAD.
...
OSStatus mico_bt_smartbridge_enable_pairing( mico_bt_smartbridge_socket_t*             socket,
                                              ...
                                              mico_bt_smartbridge_bonding_callback_t   bonding_callback );
