...
typedef enum
{
    MICO_BT_MPAF_MODE, /**< The framework uses Broadcom's proprietary Multi-Profile Application Framework (MPAF). The entire Bluetooth stack runs on the controller. The host controls the controller using remote procedure calls (RPC) */
