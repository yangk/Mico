...
extern OSStatus   mico_bt_smartbridge_bond_info_update( mico_bt_device_link_keys_t paired_device_keys );
...
static mico_bt_dev_status_t smartbridge_bt_stack_management_callback( mico_bt_management_evt_t event, mico_bt_management_evt_data_t *p_event_data )
{
    ...
    switch(event)
    {
        ...
        case BTM_PAIRED_DEVICE_LINK_KEYS_UPDATE_EVT:
        {
            ...
            mico_bt_smartbridge_bond_info_update( p_event_data->paired_device_link_keys_update );
        ...
        {
            bt_manager_log( "Passkey Notification event( PassKey generated is: %u )", (unsigned int)p_event_data->user_passkey_notification.passkey );
            break;
        }
        ...
        {
            bt_manager_log( "Passkey Request event" );
            break;
