 ...
 *
 */
mico_bool_t mico_bt_ble_update_advertising_white_list(mico_bool_t add, mico_bt_device_address_t remote_bda);

/**
 *
 * Function         mico_btm_ble_update_advertisement_filter_policy
 *
 ...
 *  @return         void
 */
mico_bool_t mico_btm_ble_update_advertisement_filter_policy(mico_bt_ble_advert_filter_policy_t advertising_policy);
